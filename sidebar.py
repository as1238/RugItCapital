...
sidebar = html.Div(
    [
        ...
        dbc.Label('tsh sell'),
        dbc.Input(id="tsh_sell", type="text", value='1'),
        dbc.Label('stop loss a'),
        dbc.Input(id="stop_loss_a", type="text", value='-225'),
        dbc.Label('stop loss b'),
        dbc.Input(id="stop_loss_b", type="text", value='225'),
        dbc.Label('lot size a'),
        dbc.Input(id="lot_size_a", type="text", value='100000'),
        dbc.Label('lot size b'),
        dbc.Input(id="lot_size_b", type="text", value='100000'),
