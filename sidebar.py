    ...
    [
        dbc.Nav(
            [
                ...
                dbc.NavLink("Pair Blotter", href="/pairBlotter", id="pairBlotter-link")
            ],
            vertical=True,
            pills=True
        ),
        ...
        dbc.Input(id="candle-average", type="text", value='7'),
        dbc.Label('tsh buy'),
        dbc.Input(id="tsh-buy", type="text", value=''),
        dbc.Label('tsh sell'),
        dbc.Input(id="tsh_sell", type="text", value=''),
        dbc.Label('stop loss a'),
        dbc.Input(id="stop_loss_a", type="text", value=''),
        dbc.Label('stop loss b'),
        dbc.Input(id="stop_loss_b", type="text", value=''),
        dbc.Label('lot size a'),
        dbc.Input(id="lot_size_a", type="text", value=''),
        dbc.Label('lot size b'),
        dbc.Input(id="lot_size_b", type="text", value=''),
